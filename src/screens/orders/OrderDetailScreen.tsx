...
const ORDENS_DETALHE: Record<string, OrdemDetalhe> = {
  '8': {ref:'2026-0008',nome:'Painel luminoso Vasco da Gama',cliente:'ADRC Vasco da Gama',estado:'EM PRODUÇÃO',prioridade:'Normal',entrega:'26/04/2026',inicioProducao:'20/03/2026 08:30',fimProducao:'—',responsavel:'Gabriel Jesus',
    ...
    materiaisAdicionais:[],historico:[{data:'20/03/2026 08:30',utilizador:'Gabriel Jesus',descricao:'Produção iniciada.'},{data:'20/03/2026 08:15',utilizador:'Gabriel Jesus',descricao:'Ordem planeada.'}]},
  '9': {ref:'2026-0009',nome:'Letreiro bar ISCAC',cliente:'AEISCAC',estado:'EM PLANEAMENTO',prioridade:'Normal',entrega:'30/03/2026',inicioProducao:'—',fimProducao:'—',responsavel:'Gabriel Jesus',
  ...
  '6': {ref:'2026-0006',nome:'Letreiro entrada piso 0',cliente:'AEISCAC',estado:'EM EXPEDIÇÃO',prioridade:'Normal',entrega:'25/03/2026',inicioProducao:'10/03/2026 09:00',fimProducao:'18/03/2026 17:00',responsavel:'Administrador PrimeTool',
    ...
    materiaisAdicionais:[{id:1,descricao:'Tinta anticorrosão adicional',qty:'1',data:'15/03/2026 10:00',utilizador:'Gabriel Jesus'}],
    historico:[{data:'18/03/2026 17:00',utilizador:'Administrador PrimeTool',descricao:'Produção concluída.'},{data:'10/03/2026 09:00',utilizador:'Administrador PrimeTool',descricao:'Produção iniciada.'}]},
  '7': {ref:'2026-0007',nome:'Letreiro entrada hotel',cliente:'Ascendi Operações, SA',estado:'EM EXPEDIÇÃO',prioridade:'Normal',entrega:'20/03/2026',inicioProducao:'05/03/2026 08:00',fimProducao:'15/03/2026 16:00',responsavel:'Gabriel Jesus',
    materiaisPlaneados:[{codigo:'PER-003',descricao:'Perfil UNP 80 (6m)',qty:'3,00'},{codigo:'CHP-001',descricao:'Chapa de aço 3mm',qty:'2,00'}],
    materiaisAdicionais:[],historico:[{data:'15/03/2026 16:00',utilizador:'Gabriel Jesus',descricao:'Produção concluída.'},{data:'05/03/2026 08:00',utilizador:'Gabriel Jesus',descricao:'Produção iniciada.'}]},
  '5': {ref:'2026-0005',nome:'Sinalética exterior campus',cliente:'Universidade do Minho',estado:'EM PRODUÇÃO',prioridade:'Alta',entrega:'15/04/2026',inicioProducao:'22/03/2026 08:00',fimProducao:'—',responsavel:'Gabriel Jesus',
    ...
    materiaisAdicionais:[],historico:[{data:'22/03/2026 08:00',utilizador:'Gabriel Jesus',descricao:'Produção iniciada.'}]},
  '4': {ref:'2026-0004',nome:'Painel LED fachada',cliente:'Grupo Sonae',estado:'AGUARDA MATERIAL',prioridade:'Normal',entrega:'10/05/2026',inicioProducao:'—',fimProducao:'—',responsavel:'Gabriel Jesus',
    ...
    materiaisAdicionais:[],historico:[{data:'18/03/2026 14:00',utilizador:'Gabriel Jesus',descricao:'Aguarda material — Fio MIG em falta.'}]},
  '3': {ref:'2026-0003',nome:'Totem publicidade exterior',cliente:'NOS Comunicações',estado:'CONCLUÍDA',prioridade:'Normal',entrega:'01/03/2026',inicioProducao:'15/02/2026 08:00',fimProducao:'28/02/2026 17:00',responsavel:'Administrador PrimeTool',
    ...
    materiaisAdicionais:[],historico:[{data:'28/02/2026 17:00',utilizador:'Administrador PrimeTool',descricao:'Produção concluída.'},{data:'15/02/2026 08:00',utilizador:'Administrador PrimeTool',descricao:'Produção iniciada.'}]},
  '2': {ref:'2026-0002',nome:'Estrutura metálica armazém',cliente:'Logística Rápida Lda',estado:'SUSPENSA',prioridade:'Urgente',entrega:'05/04/2026',inicioProducao:'—',fimProducao:'—',responsavel:'Gabriel Jesus',
    ...
    materiaisAdicionais:[],historico:[{data:'12/03/2026 09:00',utilizador:'Gabriel Jesus',descricao:'Ordem suspensa por decisão do cliente.'}]},
};
